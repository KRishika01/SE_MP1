...
public class JPAUserManagerImpl implements UserManager {
    ...
    @Inject
    public JPAUserManagerImpl(UserService userService,
                              WeblogPermissionService weblogPermissionService,
                              RoleService roleService,
                              AuthorizationService authorizationService) {
        log.debug("Instantiating JPA User Manager (facade)");
    ...
    @Override
    public void release() {
        // no-op; resources managed by injected services
    }
    ...
    public User getUserByUserName(String userName, Boolean enabled)
            throws WebloggerException {
        return userService.getUserByUserName(userName, enabled);
    }

    @Override
    public User getUserByOpenIdUrl(String openIdUrl) throws WebloggerException {
        return userService.getUserByOpenIdUrl(openIdUrl);
    }

    @Override
    public List<User> getUsers(Boolean enabled, Date startDate, Date endDate,
                               int offset, int length) throws WebloggerException {
        return userService.getUsers(enabled, startDate, endDate, offset, length);
    }
    ...
    public List<User> getUsersStartingWith(String startsWith,
            ...
            throws WebloggerException {
        return userService.getUsersStartingWith(startsWith, enabled, offset, length);
    }

    @Override
    public Map<String, Long> getUserNameLetterMap() throws WebloggerException {
        return userService.getUserNameLetterMap();
    }

    @Override
    public List<User> getUsersByLetter(char letter, int offset, int length)
            throws WebloggerException {
        return userService.getUsersByLetter(letter, offset, length);
    }
    ...
    @Override
    public void grantRole(String roleName, User user) throws WebloggerException {
        roleService.grantRole(roleName, user);
    }

    @Override
    public void revokeRole(String roleName, User user) throws WebloggerException {
        roleService.revokeRole(roleName, user);
    }

    @Override
    @Deprecated
    public boolean hasRole(String roleName, User user) throws WebloggerException {
        return roleService.hasRole(roleName, user);
    }
